...
<body style="height: 384px; width: 1951px;">
    <form id="form1" runat="server">
        ...
        <div style="height: 567px;">
            ...
            <asp:Label ID="Label1" runat="server" Style="z-index: 1; left: 630px; top: 282px; position: absolute" Text="User ID:"></asp:Label>
            ...
            <asp:TextBox ID="userID" runat="server" Style="z-index: 1; left: 738px; top: 280px; position: absolute; width: 186px;"></asp:TextBox>
            <asp:TextBox TextMode="Password" ID="password" runat="server" Style="z-index: 1; left: 738px; top: 325px; position: absolute; width: 186px;"></asp:TextBox>
