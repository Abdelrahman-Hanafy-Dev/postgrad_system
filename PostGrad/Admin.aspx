...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:Button ID="NoExtension" OnClick="ExtensionButton" runat="server" CssClass="auto-style9" Text="Add an Extension to a Thesis" />
            <asp:Button ID="AddExt" OnClick="AddExtension" runat="server" CssClass="auto-style4" Text="Add" Visible="false" />
            
            <asp:Label ID="EnterThesis" Visible="false" runat="server" Text="Enter Thesis Serial Number:" CssClass="auto-style2"></asp:Label>

            <asp:TextBox ID="ThesisSerialNumber" runat="server" CssClass="auto-style3" Visible="false" MaxLength="20" ></asp:TextBox>
