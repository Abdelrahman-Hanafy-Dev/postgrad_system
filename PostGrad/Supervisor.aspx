...
<body>
    <form id="form1" runat="server">
        ...
        <div style="height: 700px; border-style: double">
            ...
            <br />
             <center>
                <table style="width: 100%" runat="server" id="SupervisorProfileTable">
                    <tr>
                        <th>ID</th>
                        <th>Email</th>
                        <th>Password</th>
             ...
             <center>
                <table style="overflow-y:scroll;height:200px;display:block" runat="server" id="StudentThesisYearsTable">
                    <tr>
                        <th>First Name</th>
                        <th>Last Name</th>
                        <th>Years Spent</th>
            ...
            <center>
                <div>
                    <table style="overflow-y:scroll;height:200px;display:block" runat="server" id="studentPublicationsTable">
                    <tr>
                        <th>ID</th>
                        <th>Title</th>
